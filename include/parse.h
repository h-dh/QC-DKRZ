...
//! Parse input-parameter specific to the qc_main frame program.
...
(connected to the non-Base-derived QC and FD_interface objects).\n
Example of instructions in a file:\n \n
     -f path-to/hur_Amon_ECHAM6-MPIOM-LR_rcp45_r1_195501-199412.nc \n
     IN::0:QC0:FD0 \n
     QC::0:f=qc_hur_Amon_ECHAM6-MPIOM-LR_rcp45_r1.nc:returnDateRange:tablePath=...
 ...
 information, connect to the QC obj and to the FreqDist obj.
 The QC gets a filename for the results, will return a string
 ...
 both QC::0 and FD::0 are embedded in the InFile
 option-string (with appropriate syntax).
 Parameters are supplied by the script qcExecutor calling the program.\n
